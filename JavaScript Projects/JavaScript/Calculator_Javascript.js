...
const Calculator = {
    //this will disply 0 on the calculator screen
    Display_Value: '0',
...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        ...
        //we want to a dd a decimal point
...
function Handle_Operator(Next_Operator) {
    ...
    //displayed on the creeen to a number and then store the result in
...
//this function updates the calsulator screen with thte contents of Display_Value
...
Update_Display();
//this section monitory button clicks
...
keys.addEventListener('click', (event) => {
    ...
    //ensures that AC clears all inputs fromt he calculator screen
